...
origin = cv2.imread('D:/GitHub/Insect_Identification/picture/ttt.png')  #TODO改为绝对路径
RiceImg = cv2.imread('D:/GitHub/Insect_Identification/picture/ttt.png', 0)
...
print (num)
# 画轮廓
cv2.drawContours(origin, contours[0], -1, (0, 0, 255), 1)
...
cv2.imwrite('D:/GitHub/Insect_Identification/picture/tttresult.jpg',origin) #TODO改为绝对路径
k = cv2.waitKey(0)
